...
function shoppingTime(memberId, money) {
    ...
    if(memberId == undefined || memberId == ''){
        ...
        if(uang>= 1500000){
            list.listPurchased.push('Sepatu Stacattu');
            uang -= 1500000;
        }
        if(uang>= 500000){
            list.listPurchased.push('Baju Zoro');
            uang -= 500000;
        }
        if(uang>= 250000){
            list.listPurchased.push('Sweater H&N');
            uang -= 250000;
        }
        if(uang>= 175000){
            list.listPurchased.push('Sweater Uniklooh');
            uang -= 175000;
        }
        if(uang>= 50.000){
            list.listPurchased.push('Casing Handphone');
            uang -= 50000;
        }
        list.changeMoney = uang;
        return list;
    }
